...
(async function launch() {
  try {
    ...
    server.registerService('logger', serviceLoggerFactory, {
      directory: path.join(process.cwd(), 'logger-test'),
    }, []);
    ...
    const logger = server.serviceManager.get('logger');
    const metasLogger = logger.create('subfolder/metas');
